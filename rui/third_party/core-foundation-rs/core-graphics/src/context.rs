...
impl CGContextRef {
    ...
    pub fn draw_layer_in_rect(&self, layer: &CGLayerRef, rect: CGRect) {
        unsafe {
            CGContextDrawLayerInRect(self.as_ptr(), rect, layer.as_ptr());
        }
    }

    pub fn draw_layer_at_point(&self, layer: &CGLayerRef, point: CGPoint) {
        unsafe {
            CGContextDrawLayerAtPoint(self.as_ptr(), point, layer.as_ptr());
        }
    }
}
...
extern "C" {
    ...
    fn CGContextAddLineToPoint(c: ::sys::CGContextRef, x: CGFloat, y: CGFloat);
    fn CGContextBeginPath(c: ::sys::CGContextRef);
    fn CGContextClosePath(c: ::sys::CGContextRef);
    fn CGContextMoveToPoint(c: ::sys::CGContextRef, x: CGFloat, y: CGFloat);
    ...
    fn CGContextClearRect(context: ::sys::CGContextRef, rect: CGRect);
    fn CGContextFillRect(context: ::sys::CGContextRef, rect: CGRect);
    fn CGContextFillRects(context: ::sys::CGContextRef, rects: *const CGRect, count: size_t);
    fn CGContextStrokeRect(context: ::sys::CGContextRef, rect: CGRect);
    fn CGContextStrokeRectWithWidth(context: ::sys::CGContextRef, rect: CGRect, width: CGFloat);
    fn CGContextClipToRect(context: ::sys::CGContextRef, rect: CGRect);
    fn CGContextClipToRects(context: ::sys::CGContextRef, rects: *const CGRect, count: size_t);
    ...
    fn CGContextFillEllipseInRect(context: ::sys::CGContextRef, rect: CGRect);
    fn CGContextStrokeEllipseInRect(context: ::sys::CGContextRef, rect: CGRect);
    ...
    fn CGContextSetShadowWithColor(
        ...
        offset: CGSize,
        blur: CGFloat,
        color: ::sys::CGColorRef,
    );
    fn CGContextDrawLayerInRect(
        context: ::sys::CGContextRef,
        rect: CGRect,
        layer: ::sys::CGLayerRef,
    );
