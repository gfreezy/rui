...
use crate::tree::{Element, UiState};
use crate::{ext_event::ExtEventSink, tree::ElementId};
...
pub struct EventCtx<'a> {
    pub(crate) global_state: &'a mut GlobalState,
    pub(crate) arena: &'a mut Arena<Element>,
    pub(crate) ui_state: &'a mut UiState,
...
impl_context_method!(EventCtx<'_>, UpdateCtx<'_>, LifeCycleCtx<'_>, {
    ...
    pub fn request_paint(&mut self) {
        self.ui_state
            .invalid
            .set_rect(self.ui_state.paint_rect() - self.ui_state.layout_rect().origin().to_vec2());
        tracing::debug!("request paint: {:?}", self.ui_state.paint_rect());
    }
    ...
    pub fn request_paint_rect(&mut self, rect: Rect) {
        self.ui_state.invalid.add_rect(rect);
    }
    ...
    pub fn request_layout(&mut self) {
        self.ui_state.needs_layout = true;
    }
});
...
impl_context_method!(
    ...
    LayoutCtx<'_>,
    {
        ...
        pub fn request_timer(&mut self, deadline: Duration) -> TimerToken {
            self.global_state
                .request_timer(&mut self.ui_state, deadline)
        }
    }
);

impl GlobalState {
    fn request_timer(&self, child_state: &mut UiState, deadline: Duration) -> TimerToken {
...
impl LayoutCtx<'_> {
    ...
    pub fn set_paint_insets(&mut self, insets: impl Into<Insets>) {
        self.ui_state.paint_insets = insets.into().nonnegative();
    }
    ...
    pub fn set_baseline_offset(&mut self, baseline: f64) {
        self.ui_state.baseline_offset = baseline
    }
}
impl EventCtx<'_> {
    ...
    pub fn set_active(&mut self, active: bool) {
        self.ui_state.is_active = active;
    }
    ...
    pub fn request_update(&mut self) {
        self.ui_state.request_update = true;
    }
}
...
impl DerefMut for PaintCtx<'_, '_> {
